...
const style = {
    ...
    headerText: `px-5 text-[24px] text-[#0085FF] cursor-pointer border-b-[4px] border-[#0085FF] pb-2`,
    headerText2: `px-5 text-[24px] text-[#9A9A9A] hover:text-[#0085FF] cursor-pointer`,
    list: `flex flex-col`,
    item: `pt-3`
}
