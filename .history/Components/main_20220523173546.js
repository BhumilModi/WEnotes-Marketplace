            ...
            <div className={style.content} >
                <div className={style.heading}>
                    ...
                    <div className="pr-20 content">
                        <button className="text-[30px] mt-2 cursor-pointer text-[#9A9A9A] hover:text-[#000000]" onClick={sliderRef?.slickPrev}>
                        ...
                        <button className="text-[30px] mt-2 cursor-pointer text-[#9A9A9A] hover:text-[#000000]" onClick={sliderRef?.slickNext}>
