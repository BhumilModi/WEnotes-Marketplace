...
const style = {
    header: `h-[70px] flex items-center border-b-[2px] pb-10px pl-[100px] sticky top-0 z-[999] bg-[white]`,
    ...
    button: `h-[40px] w-[150px] flex justify-center items-center  bg-[#0085FF] py-[5px] pl-[20px] rounded-3xl `,
    id: `h-[40px] w-[150px] flex justify-center items-center bg-[#ffffff] border-2 border-[#0085FF] py-[5px] pl-[20px] rounded-3xl`,
}
