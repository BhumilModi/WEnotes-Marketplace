...
const style = {
    wrapper: `h-[250px] w-[500px] bg-[#F8F8F8] rounded-md flex p-4 mt-[5px] ml-[20px] flex-shrink-0`,
...
export default function Notes({ image, header, author, description, price }) {
    return (
        <div className={style.wrapper}>
            <Image src={image} className={style.noteImg} alt={note1}></Image>
