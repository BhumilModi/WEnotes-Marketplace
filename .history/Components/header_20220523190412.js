...
const style = {
    ...
    searchBar: `h-[40px] w-[300px] flex rounded-3xl border-2 items-center border-[black]`,
    ...
    button: `h-[40px] w-[150px] flex justify-center items-center mr-[20px] bg-[#0085FF] py-[5px] px-[20px] rounded-sm cursor-pointer`,
}
