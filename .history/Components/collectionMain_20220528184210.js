...
const style = {
    wrapper: `flex flex-col pt-[15px] overflow-y-scroll scrollbar-hide`,
    content: `mt-5 grid grid-cols-2 gap-4`,
    heading: `flex justify-between pt-2`,
    ...
    return (
        <div className={style.wrapper}>
            <div className={style.heading}>
                <div className={style.headText}>Notes Collection</div>
            </div>
