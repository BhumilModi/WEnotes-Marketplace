...
const style = {
    wrapper: `h-[250px] w-[500px] bg-[#EFEFEF] rounded-md flex p-4 mt-[5px] ml-[20px] flex-shrink-0 border-0 hover:border-2 border-[#0085FF] hover:ease-in-out hover:delay-300`,
