            ...
            <div className={style.request}>
                ...
                <div className="flex flex-col border-b-2">
                    ...
                    <div className="h-[30px] flex pl-3">
                        <div className="bg-[#00FFC2] px-3 h-[20px] w-[60px] mr-3 text-[12px] rounded-sm cursor-pointer">Accept</div>
                        <div className="bg-[#FF7070] px-3 h-[20px] w-[60px] mr-3 text-[12px] rounded-sm cursor-pointer">Reject</div>
                    </div>
                </div>
                <div className="flex flex-col border-b-2">
                    <div className="flex justify-between text-[18] w-[300px] pt-2 h-[40px]">
