...
import dbNotes from "./dblistCard"
                    ...
                    <div className={style.list}>
                        {
                            notes.map((note, index) => (
                                <dbNotes key={index} img={note.image} header={note.header} description={note.description} author={note.author} price={note.price}  ></CollectionNotes>
                            ))
                        }
                    </div>
                </div>
